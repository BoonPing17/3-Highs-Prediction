...
import pickle
with open("C:\\Users\Boon Ping\\Desktop\\WIA1006 Group Assignment\\WIA1006 Group Assignment\\random_forest_model.pkl","rb") as file:
...
class App(customtkinter.CTk):
    def __init__(self):
        ...
        #Image paths
        image_paths = [
            "C:\\Users\\Boon Ping\\Downloads\\ImageIntroduction1.jpeg",
            "C:\\Users\\Boon Ping\\Downloads\\ImageIntroduction2.jpg",
            "C:\\Users\\Boon Ping\\Downloads\\ImageIntroduction3.jpg"
        ]
    ...
    def display_prediction_result(self, prediction_labels):
        ...
        result_image = Image.open("C:\\Users\\Boon Ping\\Downloads\\ResultsIcon.png")
        result_image = result_image.resize((50, 50))  # Adjust the size as needed
        result_icon = ImageTk.PhotoImage(result_image)

        advice_image = Image.open("C:\\Users\\Boon Ping\\Downloads\\AdviceIcon.png")
